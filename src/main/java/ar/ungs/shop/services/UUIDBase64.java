...
public enum UUIDBase64 {
	...
	BASIC(Base64.getEncoder(), Base64.getDecoder()), MIME(Base64.getMimeEncoder(), Base64.getMimeDecoder()),
	...
	public String encode() {
		...
		ByteBuffer buffer = ByteBuffer.allocate(16).putLong(value.getMostSignificantBits())
